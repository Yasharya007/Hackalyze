...
const TeacherSubmissionsPage = () => {
    console.log("TeacherSubmissionsPage component rendering");
        ...
        <div className="flex w-full min-h-screen bg-gray-100">
            ...
            <main className="flex-1 p-6">
                <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                    <h1 className="text-2xl font-bold mb-2">Submission Analytics</h1>
                    <p className="text-gray-600">View statistics and manage submissions for your hackathons</p>
                </div>
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 md:col-span-2">
                                <h2 className="text-xl font-semibold mb-4">Select Hackathon to View Submissions</h2>
                                ...
                                {hackathons.length === 0 ? (
                                    ...
                                    <>
                                        ...
                                        >
                                            <span>Proceed to Submissions</span>
